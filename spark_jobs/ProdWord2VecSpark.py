...
def create_tag_sequences(seq, broadcast_var, sample_rate=10):
    seq_length = len(seq)
    new_seqs = []
...
word2vec = Word2Vec().setVectorSize(args.vector_size).setNumIterations(300).setWindowSize(2).setMinCount(5)
